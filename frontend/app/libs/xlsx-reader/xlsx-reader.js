    ...
    XLSXReader.utils = {
        'intializeFromFile': function(obj, file, readCells, toJSON, handler) {
            ...
            reader.onload = function(e) {
                ...
                obj.json = XLSXReader.utils.to_json(workbook);
                handler(obj);
            };
        ...
        'parseWorkbook': function(workbook, readCells, toJSON) {
            ...
            for(var i = workbook.SheetNames.length-1 ; i >= 0; i--){
                ...
                sheets[workbook.SheetNames[i]] = XLSXReader.utils.parseSheet(sheet, readCells);
                
            }

//            _.eachRight(workbook.SheetNames, function(sheetName) {
