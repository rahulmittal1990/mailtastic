...
//Hauptmenü oben
function haupt_menu(){
    register_nav_menu('hauptmenue', __( 'Haupt Menü' ));
}
add_action('init', 'haupt_menu');


/**
 * Walker Klasse zum generieren der Menupunkte
 */
class Custom_Walker_Nav_Menu extends Walker_Nav_Menu {
  function start_el ( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$item_output .= '<a'. $attributes .'>';
                //OWN EDIT
                $item_output .= '<span class="navigationspan">';
		$item_output .= $args->link_before . strtoupper($title) . $args->link_after;
                //OWN EDIT
                $item_output .= '</span>';
		$item_output .= '</a>';
...
////wp_enqueue_script('masterslider.map', get_template_directory_uri() .'/js/masterslider.map','','', false);
