					...
					'front_form' => array(
						...
						'fields' => array(
							...
							'order' => array(
								...
								'type' => 'sortable',
								'default' => 'name,subtitle,url,image,testimonialTitle,testimonial,rating,email,yesOrNo,humanVerification,category'
							) ,
							...
							'mandatory' => array(
								...
								'default' => 'name, email, url, subtitle, testimonial_title, testimonial, rating, image'
							) ,
