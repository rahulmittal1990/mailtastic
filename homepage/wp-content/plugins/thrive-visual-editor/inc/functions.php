...
if ( ! function_exists( 'tve_load_tcb_classes_f' ) ) {
	/**
	 * called on the 'init' hook
	 *
	 * put it inside the if because this function was declared in thrive-visual-editor.php
	 * and it could be declared twice generating fatal error when:
	 * - tcb deactivate
	 * - tl update
	 * - tcb activating
	 * - fatal error
	 ...
	 */
	function tve_load_tcb_classes_f() {
